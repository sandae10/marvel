...
enum class NavItem(
    ...
    COMICS(NavCommand.ContentType(Feature.COMICS), Icons.Default.Menu, R.string.comics),
    EVENTS(NavCommand.ContentType(Feature.EVENTS), Icons.Default.MoreVert,R.string.events)
}
